...
public class T5SemanticoUtils {
    ...
    public static TipoT5 verificarTipo(TabelaDeSimbolos tabela, t5GramParser.Parcela_nao_unarioContext ctx) {
        TipoT5 tipoRetorno;
        String nome;
    ...
    public static TipoT5 verificarTipo(TabelaDeSimbolos tabela, t5GramParser.Fator_logicoContext ctx) {
        TipoT5 tipoRetorno = verificarTipo(tabela, ctx.parcela_logica());
        return tipoRetorno;
    }

    public static TipoT5 verificarTipo(TabelaDeSimbolos tabela, t5GramParser.Parcela_logicaContext ctx) {
        TipoT5 tipoRetorno;
    ...
    public static TipoT5 verificarTipo(TabelaDeSimbolos tabela, t5GramParser.Exp_relacionalContext ctx) {
