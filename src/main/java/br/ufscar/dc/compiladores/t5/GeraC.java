...
public class GeraC extends t5GramBaseVisitor<Void> {
    ...
    @Override
    public Void visitPrograma(t5GramParser.ProgramaContext ctx) {
    ...
    @Override
    public Void visitDeclaracao_local(t5GramParser.Declaracao_localContext ctx) {
    ...
    @Override
    public Void visitVariavel(t5GramParser.VariavelContext ctx) {
        ...
        if (ctx.tipo().tipo_estendido() != null) {
            ...
            for (t5GramParser.IdentificadorContext ictx : ctx.identificador()) {
        ...
        // Caso seja a declaração de um novo registro.
            ...
            saida.append("struct{\n");
            for (t5GramParser.VariavelContext vctx : ctx.tipo().registro().variavel()) {
                visitVariavel(vctx);
            }
    ...
    @Override
    public Void visitDeclaracao_global(t5GramParser.Declaracao_globalContext ctx) {
        ...
        if (ctx.parametros() != null) {
            for (t5GramParser.ParametroContext pctx : ctx.parametros().parametro()) {
                tipo = verificaTipoC(pctx.tipo_estendido().getText());
                nomeVariaveis = "";

                for (t5GramParser.IdentificadorContext ictx : pctx.identificador()) {
        ...
        // Executa os comandos.
        for (t5GramParser.CmdContext cctx : ctx.cmd()) {
            visitCmd(cctx);
        }
    ...
    @Override
    public Void visitParcela_nao_unario(t5GramParser.Parcela_nao_unarioContext ctx) {
    ...
    @Override
    public Void visitParcela_unario(t5GramParser.Parcela_unarioContext ctx) {
    ...
    @Override
    public Void visitOp_relacional(t5GramParser.Op_relacionalContext ctx) {
    ...
    @Override
    public Void visitCmdRetorne(t5GramParser.CmdRetorneContext ctx) {
    ...
    @Override
    public Void visitCmdAtribuicao(t5GramParser.CmdAtribuicaoContext ctx) {
    ...
    @Override
    public Void visitExpressao(t5GramParser.ExpressaoContext ctx) {
    ...
    @Override 
    public Void visitTermo_logico(t5GramParser.Termo_logicoContext ctx){
    ...
    @Override
    public Void visitFator_logico(t5GramParser.Fator_logicoContext ctx) {
    ...
    @Override
    public Void visitOp2(t5GramParser.Op2Context ctx) {
    ...
    @Override
    public Void visitParcela_logica(t5GramParser.Parcela_logicaContext ctx) {
    ...
    @Override
    public Void visitExp_relacional(t5GramParser.Exp_relacionalContext ctx) {
    ...
    @Override
    public Void visitCmdSe(t5GramParser.CmdSeContext ctx) {
        ...
        for (t5GramParser.CmdContext cctx : ctx.cmdEntao)
            super.visitCmd(cctx);
        ...
        if (ctx.getText().contains("senao")) {
            ...
            for (t5GramParser.CmdContext cctx : ctx.cmdSenao)
                super.visitCmd(cctx);
    ...
    @Override
    public Void visitCmdLeia(t5GramParser.CmdLeiaContext ctx) {
    ...
    @Override
    public Void visitCmdEnquanto(t5GramParser.CmdEnquantoContext ctx) {
    ...
    @Override
    public Void visitCmdPara(t5GramParser.CmdParaContext ctx) {
    ...
    @Override
    public Void visitCmdFaca(t5GramParser.CmdFacaContext ctx) {
    ...
    @Override
    public Void visitCmdEscreva(t5GramParser.CmdEscrevaContext ctx) {
        ...
        for (t5GramParser.ExpressaoContext ectx : ctx.expressao()) {
    ...
    @Override
    public Void visitCmdCaso(t5GramParser.CmdCasoContext ctx) {
        ...
        for (t5GramParser.Item_selecaoContext sctx : ctx.selecao().item_selecao()) {
            ...
            for (t5GramParser.CmdContext cctx : sctx.cmd())
                visitCmd(cctx);
    ...
    @Override
    public Void visitCmdChamada(t5GramParser.CmdChamadaContext ctx) {
